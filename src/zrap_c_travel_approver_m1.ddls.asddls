...
define root view entity ZRAP_C_TRAVEL_APPROVER_M1
  provider contract transactional_query
  as projection on ZRAP_I_TRAVEL_M1

{
      @EndUserText.quickInfo: 'Travel request'
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZRAP_I_TRAVEL_M',
                                                    element: 'TravelId' } }]
  ...
  key TravelId,
      ...
      /* Associations */
      agency,
      Booking : redirected to composition child ZRAP_C_BOOKING_APPROVER_M1,
      currency,
      customer,
      status
}
